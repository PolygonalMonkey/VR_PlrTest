...
if [ -f "D:\Programs\EpicGames\Epic Games\4.14\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "D:\Programs\EpicGames\Epic Games\4.14\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
